...
export const DOC_TYPE_DRIVE_PREFIX: Record<string, string> = {
  ...
  us_address_proof: "proof_us_address",
  indian_address_proof: "proof_india_address",
  ...
  govt_application_form: "form_govt_application",
  annexure_e_signed: "annexure_e_signed",
  appearance_signature_affidavit_signed: "affidavit_appearance_signature",
  vfs_payment_receipt: "receipt_vfs_payment",
  courier_label_receipt: "receipt_courier",
  spouse_name_change_proof: "proof_spouse_name_change",
  joint_photo_declaration: "declaration_joint_photo",
  name_change_affidavit: "affidavit_name_change",
  name_change_newspaper_ads: "proof_name_change_news",
  parent_name_change_supporting_docs: "proof_parent_name_change",
  birth_or_school_leaving_certificate: "certificate_birth_or_school",
  dob_change_proof: "proof_dob_change",
  dob_change_court_order: "order_dob_change",
