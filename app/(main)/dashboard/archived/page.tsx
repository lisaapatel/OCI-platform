                  ...
                  >
                    ...
                    <td className="px-4 py-3">
                      <span className="inline-flex flex-wrap items-center gap-2">
                        ...
                        {app.is_minor === true ? (
                          <span className="inline-flex items-center rounded-full border border-violet-200 bg-violet-50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-violet-900">
                            Minor
                          </span>
                        ) : null}
                      </span>
